/**
 * The EmployeeCollection class is a program that manages a collection of Employee objects and allows
 * for various operations such as adding, deleting, and updating employees, as well as retrieving
 * information about the senior most employee and employees with a particular status.
 */
